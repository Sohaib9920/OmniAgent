...
export default function ChainNode({ data }) {
  ...
  return (
    <div
      onClick={data.delete}
      className="chain-node relative bg-white h-16 w-40 border rounded-sm solid border-black flex flex-col justify-center"
    >
      ...
      <div className="w-full h-min text-xs text-center">Chain data</div>
